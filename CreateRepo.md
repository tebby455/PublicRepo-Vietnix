...
# Cài đặt public repo trên server có sẵn

- Ở mục này bạn cần 1 con webserver có sẵn, có thể dùng trên máy ảo để chạy thử, nếu đã thành công hãy trải nghiệm thử bằng 1 con server thật, tham khảo thêm thuê server tại <a href='https://vietnix.vn/'>đây</a> 
